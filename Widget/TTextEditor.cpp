...
void TTextEditor::updateLineNumberAreaWidth(int /* newBlockCount */)
{
    setViewportMargins(lineNumberAreaWidth(), 0, 0, 0);
}

void TTextEditor::updateLineNumberArea(const QRect &rect, int dy)
{
    if (dy)
...
void TTextEditor::highlightCurrentLine()
{
...
void TTextEditor::lineNumberAreaPaintEvent(QPaintEvent *event)
{
